    ...
    return (
        <div className="lg:w-1/3 w-full p-4 pb-10">
            ...
            <div className="text-center">
                <h2 className="w-32 lg:text-sm text-2xl font-medium my-8 mx-auto py-1 border-b-2 border-orange-500">
                    {props.kind}
                </h2>
                <h3 className="lg:text-3xl text-5xl title-font font-medium text-gray-900 mb-3">
                    {props.title}
                </h3>
