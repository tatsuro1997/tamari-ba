                    ...
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-24 mx-auto">
                            <div class="flex flex-col text-center w-full mb-20">
                                <div class="mx-auto">
                                    <h1 class="sm:text-3xl lg:text-5xl font-medium title-font mb-4 text-gray-900">Tamari-Baとは？</h1>
                            ...
                            <div class="flex flex-wrap -m-4">
                                <div class="lg:w-1/3 sm:w-1/2 p-4">
                                    ...
                                    <div class="text-center">
                                        <h2 class="w-32 text-sm font-medium my-2 mx-auto py-1 border border-orange-500">ソロ</h2>
                                ...
                                <div class="lg:w-1/3 sm:w-1/2 p-4">
                                    ...
                                    <div class="text-center">
                                        <h2 class="w-32 text-sm font-medium my-2 mx-auto py-1 border border-orange-500">ツーリング</h2>
                                ...
                                <div class="lg:w-1/3 sm:w-1/2 p-4">
                                    ...
                                    <div class="text-center">
                                        <h2 class="w-32 text-sm font-medium my-2 mx-auto py-1 border border-orange-500">カスタム</h2>
                                ...
                                <div class="lg:w-1/3 sm:w-1/2 p-4 lg:mt-20">
                                    ...
                                    <div class="text-center">
                                        <h2 class="w-32 text-sm font-medium my-2 mx-auto py-1 border border-orange-500">交流</h2>
                                ...
                                <div class="lg:w-1/3 sm:w-1/2 p-4 lg:mt-20">
                                    ...
                                    <div class="text-center">
                                        <h2 class="w-32 text-sm font-medium my-2 mx-auto py-1 border border-orange-500">バイク✕？？</h2>
                                ...
                                <div class="lg:w-1/3 sm:w-1/2 p-4 lg:mt-20">
                                    ...
                                    <div class="text-center">
                                        <h2 class="w-32 text-sm font-medium my-2 mx-auto py-1 border border-orange-500">Enjoy</h2>
