<form class="w-1/2 h-12 text-center flex" method="GET" action="{{ route('user.roads.index') }}">
    ...
    <div class="flex h-10 justify-content-center">
        ...
        <button class="my-2 ml-2">
            <a href="{{ route('user.roads.index') }}" class="flex-shrink-0 border-transparent border-2 text-gray-500 hover:text-gray-800 text-sm py-1 px-2 rounded border-gray-400 border-dotted">
                クリア
            </a>
        </button>
    </div>
