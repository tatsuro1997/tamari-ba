<div class="w-full">
    <form method="post" action="{{ route('user.road.comment.store', ['road' => $road->id]) }}" class="w-1/2" >
        ...
        <div class="border-b border-blue-500 my-2">
            ...
            <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" placeholder="コメント入力 ..." type="text" name="comment" />
        </div>
        ...
        <button type="button" class="flex-shrink-0 border-transparent border-4 text-gray-500 hover:text-gray-800 text-sm py-1 px-2 rounded">
            キャンセル
        </button>
    </form>
    <div id="commentList">
