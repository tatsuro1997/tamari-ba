<div class="-m-2">
  ...
  <div class="p-2 w-1/2 mx-auto">
      <div class="relative">
      <label for="background_image" class="leading-7 text-sm text-gray-600">プロフィール画像</label>
  ...
  <div class="p-2 w-full flex justify-around mt-4">
      <button type="button" onclick="location.href='{{ route('user.profile') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
