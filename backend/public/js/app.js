...
$(function () {
  ...
  like.on('click', function () {
    var $this = $(this);
    likeId = $this.data('likeid'); // bike, roadによって処理を分ける
    ...
    .done(function (data) {
      console.log(data.likesCount); //lovedクラスを追加

      $this.toggleClass('text-red-600'); //.likesCountの次の要素のhtmlを「data.roadLikesCount」の値に書き換える
...
__webpack_require__(/*! ./_like.js */ "./resources/js/_like.js");
